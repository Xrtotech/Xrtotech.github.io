...
<img src="../images/image-20250420092303958.png" style="zoom:75%;border-radius: 10px;" />
...
<img src="../images/image-20250420092533982.png" style="zoom:75%;border-radius: 10px;" />

### Step 2: Name Your Template

Assign a clear and meaningful name to the new template — for example:  `limited-sales`.

<img src="../images/image-20250420092623004.png" style="zoom:75%;border-radius: 10px;" />

### Step 3: Add the Lightnsale UI Block

In the **Product Information** section, click **Add section**, then select **Apps**:  `Lightnsale`

<img src="../images/image-20250420092747496.png" style="zoom:75%;border-radius: 10px;" />
...
<img src="../images/image-20250420092928360.png" style="zoom:75%;border-radius: 10px;" />
